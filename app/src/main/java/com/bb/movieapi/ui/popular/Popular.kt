package com.bb.movieapi.ui.popular
...
import com.bb.movieapi.databinding.FragmentPopularBinding
        ...
        vm.popular.observe(viewLifecycleOwner,{
            ...
            when(it){
                ...
                is com.bb.movieapi.API.Response.ErrMsg->{
                    GlobalScope.launch {
                        var list: ArrayList<MovieData> = vm.repository.getOfflineData(1)
