package com.bb.movieapi.ui.topRated
...
import com.bb.movieapi.databinding.FragmentTopRatedBinding
        ...
        vm.topRated.observe(viewLifecycleOwner,{
            ...
            when(it){
                ...
                is com.bb.movieapi.API.Response.ErrMsg->{
                    GlobalScope.launch {
                        var list: ArrayList<MovieData> = vm.repository.getOfflineData(2)
